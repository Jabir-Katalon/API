...
def create_user_payload = '{"id": 1, "firstName": "John", "lastName": "Doe", "email": "john.doe@email.com", "password": "password123", "phone": "1234567890", "userStatus": 1}'
...
def created_user_username = new JsonSlurper().parseText(createUserResponse.getResponseText()).get("username")

def deleteUserRequest = findTestObject('Object Repository/Swagger Petstore - OpenAPI 3_0 (4)/_user_username_/deleteUser', ['username': created_user_username])
