...
def categoryRequest = findTestObject('Object Repository/Swagger Petstore - OpenAPI 3_0 (4)/_category/addCategory')
...
def petPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"name": "doggie", "photoUrls": ["url1", "url2"], "category": {"id": 1, "name": "Dogs"}, "status": "available"}'))
