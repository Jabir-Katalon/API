...
def petPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"name": "TestPet__unique__", "photoUrls": ["https://example.com/photo1"]}'))
...
def invalidPetId = "invalid_id"
def deletePetRequest = findTestObject('Object Repository/Swagger Petstore - OpenAPI 3_0 (4)/_pet_petId_/deletePet', ['petId': invalidPetId])
