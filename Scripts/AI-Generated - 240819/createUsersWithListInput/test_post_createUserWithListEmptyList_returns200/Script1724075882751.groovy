...
def createWithListRequest = findTestObject('Object Repository/Swagger Petstore - OpenAPI 3_0 (4)/_user_createWithList/createUsersWithListInput')
addHeaderConfiguration(createWithListRequest)
def userPayload = new HttpTextBodyContent(replaceSuffixWithUUID('[]'))
createWithListRequest.setBodyContent(userPayload)
