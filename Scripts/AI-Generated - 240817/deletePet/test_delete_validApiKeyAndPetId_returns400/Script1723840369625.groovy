...
def addPetPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"name": "TestPet__unique__", "photoUrls": ["http://example.com/photo1"]}'))
...
def deletePetRequest = findTestObject('Object Repository/Swagger Petstore - OpenAPI 3_0 (1)/_pet_petId_/deletePet', ['petId': pet_id])
