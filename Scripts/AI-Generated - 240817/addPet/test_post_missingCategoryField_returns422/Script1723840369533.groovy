...
def petPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"name": "doggie", "photoUrls": ["url1", "url2"], "category": {"id": 1, "name": "category__unique__"}, "tags": [], "status": "available"}'))
