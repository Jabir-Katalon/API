...
def orderPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"petId": 999999, "quantity": 1, "shipDate": "2022-01-01T00:00:00.000Z", "status": "placed", "complete": false}'))
...
println(orderResponse.getStatusCode())
