...
def userPayload = '{"id": 10, "username": "testUser", "firstName": "John", "lastName": "Doe", "email": "john.doe@email.com", "password": "password__unique__", "phone": "12345", "userStatus": 1}'
...
def responseStatusCode = deleteUserResponse.getStatusCode()
