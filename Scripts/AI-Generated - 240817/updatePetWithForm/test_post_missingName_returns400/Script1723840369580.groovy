...
def petPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"id": 10, "category": {"id": 1, "name": "Dogs"}, "photoUrls": ["url1"], "tags": [], "status": "available"}'))
...
def verifyStatusCode = petResponse.getStatusCode()
println("Step 3 - Verify Status Code 400: ${verifyStatusCode}")
