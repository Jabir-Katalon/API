...
def petPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"name": "TestPet__unique__", "photoUrls": ["https://example.com/photo"], "status": "available"}'))
...
def emptyImagePayload = new HttpTextBodyContent(replaceSuffixWithUUID('{}'))
...
uploadImageRequest.setBodyContent(emptyImagePayload)
