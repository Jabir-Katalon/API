...
def petPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"name": "Fluffy__unique__", "photoUrls": ["https://example.com/photo1.jpg"], "status": "available"}'))
...
def largeImageFile = new File('large_image.jpg')
...
def uploadImageFiles = ['file': largeImageFile]
def uploadImageRequestWithFiles = uploadImageRequest.setHttpBody(uploadImageFiles)
addHeaderConfiguration(uploadImageRequest)
def uploadImageResponse = WSBuiltInKeywords.sendRequest(uploadImageRequestWithFiles)
