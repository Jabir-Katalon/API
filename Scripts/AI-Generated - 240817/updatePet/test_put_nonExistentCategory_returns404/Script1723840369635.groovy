...
def addPetPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"name": "doggie", "photoUrls": ["url1", "url2"], "category": {"id": 999, "name": "Non-existent Category__unique__"}}'))
...
def updatePetPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"id": ' + pet_id + ', "name": "doggie", "photoUrls": ["url1", "url2"], "category": {"id": 999, "name": "Non-existent Category__unique__"}}'))
